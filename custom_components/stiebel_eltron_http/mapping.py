...
HEADER_ALIASES: dict[CanonicalKey, list[str]] = {
    ...
    CanonicalKey.PROCESS_DATA_SECTION: ["PROCESS DATA", "PROZESSDATEN", "PROZESS DATEN", "PROZESS-DATEN", "DONNEES DE PROCESSUS", "DONNEES PROCESS", "PROCESGEGEVENS", "DATI DI PROCESSO", "DATI PROCESSO", "PROCESSDATA", "DATOS DE PROCESO", "DANE PROCESU", "PROCESNI DATA"],
    ...
    CanonicalKey.AMOUNT_OF_HEAT_SECTION: ["AMOUNT OF HEAT", "MENGE DER WÄRME", "WÄRMEMENGE", "MENGE", "QUANTITE DE CHALEUR", "HOEVEELHEID WARMTE", "QUANTITA DI CALORE", "QUANTITA CALORE", "QUANTITÀ CALORE", "VÄRMEMÄNGD", "CAUDAL CALORÍFICO", "CAUDAL CALORIFICO", "ILOSC CIEPLA", "MNOZSTVI TEPLA"],
    ...
    CanonicalKey.HOT_GAS_TEMPERATURE: ["HEISSGASTEMPERATUR", "HOT GAS TEMPERATURE", "TEMP. GAZ CHAUDS", "TEMPERATURE GAZ CHAUDS", "PERSGASTEMPERATUUR", "TEMP GAS CALDO", "TEMPERATURA GAS CALDO", "HETGASTEMPERATUR", "TEMP. DEL GAS CALIENTE", "TEMP. GAZU GORACEGO", "TEPLOTA HORKEHO PLYNU"],
    ...
    CanonicalKey.OIL_SUMP_TEMPERATURE: ["ÖLSUMPFTEMPERATUR", "OELSUMPFTEMPERATUR", "OIL SUMP TEMPERATURE", "TEMP. CARTER HUILE", "TEMPERATURE CARTER HUILE", "OLIECARTERTEMPERATUUR", "TEMPERATURA COPPA OLIO", "TEMP COPPA OLIO", "OLJESUMPTEMPERATUR", "TEMP. COLECTOR ACEITE", "TEMP MISKI OLEJOWEJ", "TEPLOTA OLEJOVE VANY"],
    CanonicalKey.LOW_PRESSURE: ["DRUCK NIEDERDRUCK", "NIEDERDRUCK", "LOW PRESSURE", "PRESSION BP", "BASSE PRESSION", "PRESSION BASSE PRESSION", "DRUK LAGEDRUK", "PRESS BASSA PRESSIONE", "BASSA PRESSIONE", "TRYCK LÅGTRYCK", "PRESIÓN BAJA PRESIÓN", "PRESION BAJA PRESION", "WART NISKIEGO CISNIENIA", "TLAK NIZKY TLAK"],
    CanonicalKey.HIGH_PRESSURE: ["DRUCK HOCHDRUCK", "HOCHDRUCK", "HIGH PRESSURE", "PRESSION HP", "HAUTE PRESSION", "PRESSION HAUTE PRESSION", "DRUK HOGEDRUK", "PRESS ALTA PRESSIONE", "ALTA PRESSIONE", "TRYCK HÖGTRYCK", "PRESIÓN ALTA PRESIÓN", "PRESION ALTA PRESION", "WART WYSOKIEGO CISNIENIA", "TLAK VYSOKY TLAK"],
    CanonicalKey.WATER_FLOW: ["WP WASSERVOLUMENSTROM", "WASSERVOLUMENSTROM", "WATER FLOW", "WATER VOLUME FLOW", "DEBIT EAU PAC", "DEBIT D'EAU", "WP WATERDEBIET", "WATERDEBIET", "FLUSSO VOL ACQUA WP", "FLUSSO ACQUA", "WP VATTENVOLYMSTRÖM", "VATTENVOLYMSTRÖM", "CAUDAL AGUA WP", "WP PRZEPLYW WODY", "TC PRUTOK VODY"],
    CanonicalKey.INVERTER_CURRENT: ["STROM INVERTER", "INVERTER CURRENT", "COURANT ONDULEUR", "INTENSITE ONDULEUR", "INTENSITE INVERTER", "STROOM INVERTER", "CORRENTE INVERTER", "STRÖM INVERTER", "INVERSOR CORRIENTE", "PRAD INWERTERA", "PROUD INVERTORU"],
    CanonicalKey.INVERTER_VOLTAGE: ["SPANNUNG INVERTER", "SPANNUNG", "INVERTER VOLTAGE", "VOLTAGE", "TENSION ONDULEUR", "TENSION INVERTER", "SPANNING INVERTER", "TENSIONE INVERTER", "SPÄNNING INVERTER", "TENSIÓN INVERSOR", "NAPIECIE INWERTERA", "NAPETI INVERTORU"],
    ...
    CanonicalKey.EVAPORATOR_INLET_TEMPERATURE: ["VERDAMPFEREINTRITTSTEMPERATUR", "EVAPORATOR INLET TEMPERATURE", "TEMP. ENTREE EVAPORATEUR", "TEMP. ENTRÉE ÉVAPORATEUR", "INGANGSTEMPERATUUR VERDAMPER", "TEMPERATURA INGRESSO EVAPORATORE", "TEMP INGRESSO EVAPORATORE", "FÖRÅNGARENS INLOPPSTEMPERATUR", "TEMPERATURA DE ENTRADA DEL EVAPORADOR", "TEMPERATURA WLOTU PAROWNIKA", "VÝPARNÍK, VSTUPNÍ TEPLOTA", "VÝPARNÍK, VSTUPNI TEPLOTA"],
    CanonicalKey.EVAPORATOR_OUTLET_TEMPERATURE: ["VERDAMPFERAUSTRITTSTEMPERATUR", "EVAPORATOR OUTLET TEMPERATURE", "TEMP. SORTIE EVAPORATEUR", "TEMP. SORTIE ÉVAPORATEUR", "UITGANGSTEMPERATUUR VERDAMPER", "TEMPERATURA USCITA EVAPORATORE", "TEMP USCITA EVAPORATORE", "FÖRÅNGARENS UTLOPPSTEMPERATUR", "TEMPERATURA DE SALIDA DEL EVAPORADOR", "TEMPERATURA WYLOTU PAROWNIKA", "VÝPARNÍK, VÝSTUPNÍ TEPLOTA", "VÝPARNÍK, VYSTUPNI TEPLOTA"],
