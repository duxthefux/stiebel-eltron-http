...
HEADER_ALIASES: dict[CanonicalKey, list[str]] = {
    ...
    CanonicalKey.ROOM_TEMPERATURE_SECTION: ["ROOM TEMPERATURE", "RAUMTEMPERATUR", "RAUM TEMPERATUR", "TEMP. AMBIANT", "TEMP. AMBIANTE"],
    CanonicalKey.HEATING_SECTION: ["HEATING", "HEIZUNG", "CHAUFFAGE"],
    CanonicalKey.PROCESS_DATA_SECTION: ["PROCESS DATA", "PROZESSDATEN", "PROZESS DATEN", "PROZESS-DATEN", "DONNEES DE PROCESSUS", "DONNEES PROCESS"],
    CanonicalKey.DHW_SECTION: ["DHW", "Warmwasser", "WW", "TRINKWASSER", "DHW (Warmwasser)", "EAU CHAUDE SA", "EAU CHAUDE SANITAIRE", "ECS"],

    # Sections on the "Info > Heat Pump" page
    CanonicalKey.AMOUNT_OF_HEAT_SECTION: ["AMOUNT OF HEAT", "MENGE DER WÄRME", "WÄRMEMENGE", "MENGE", "QUANTITE DE CHALEUR"],
    ...
    CanonicalKey.EFFICIENCY_SECTION: ["EFFICIENCY", "EFFIZIENZ", "EFFICACITE", "EFFICACITÉ"],

    # Diagnosis
    CanonicalKey.ISG_SECTION: ["ISG"],

    # Start page labels
    CanonicalKey.START_BETRIEBSART: ["BETRIEBSART", "OPERATION", "OPERATION MODE", "OPERATING MODE", "MODE", "MODE DE FONCTIONNEMENT"],
    ...
    CanonicalKey.ACTUAL_TEMPERATURE_1: ["ACTUAL TEMPERATURE 1", "ISTTEMPERATUR HK 1", "ISTTEMPERATUR 1", "ISTTEMPERATUR", "CONSIGNE TEMP. CC1"],
    CanonicalKey.RELATIVE_HUMIDITY_1: ["RELATIVE HUMIDITY 1", "RAUMFEUCHTE 1", "RAUMFEUCHTE", "RELATIVE HUMIDITY", "HUMIDITE RELATIVE 1"],
    ...
    CanonicalKey.ACTUAL_TEMPERATURE: ["ACTUAL TEMPERATURE", "ISTTEMPERATUR", "TEMP. REELLE", "TEMPERATURE REELLE"],
    ...
    CanonicalKey.HOT_GAS_TEMPERATURE: ["HEISSGASTEMPERATUR", "HOT GAS TEMPERATURE", "TEMP. GAZ CHAUDS", "TEMPERATURE GAZ CHAUDS"],
    ...
    CanonicalKey.OIL_SUMP_TEMPERATURE: ["ÖLSUMPFTEMPERATUR", "OELSUMPFTEMPERATUR", "OIL SUMP TEMPERATURE", "TEMP. CARTER HUILE", "TEMPERATURE CARTER HUILE"],
    CanonicalKey.LOW_PRESSURE: ["DRUCK NIEDERDRUCK", "NIEDERDRUCK", "LOW PRESSURE", "PRESSION BP", "BASSE PRESSION", "PRESSION BASSE PRESSION"],
    CanonicalKey.HIGH_PRESSURE: ["DRUCK HOCHDRUCK", "HOCHDRUCK", "HIGH PRESSURE", "PRESSION HP", "HAUTE PRESSION", "PRESSION HAUTE PRESSION"],
    CanonicalKey.WATER_FLOW: ["WP WASSERVOLUMENSTROM", "WASSERVOLUMENSTROM", "WATER FLOW", "WATER VOLUME FLOW", "DEBIT EAU PAC", "DEBIT D'EAU"],
    CanonicalKey.INVERTER_CURRENT: ["STROM INVERTER", "INVERTER CURRENT", "COURANT ONDULEUR", "INTENSITE ONDULEUR", "INTENSITE INVERTER"],
    CanonicalKey.INVERTER_VOLTAGE: ["SPANNUNG INVERTER", "SPANNUNG", "INVERTER VOLTAGE", "VOLTAGE", "TENSION ONDULEUR", "TENSION INVERTER"],
    ...
    CanonicalKey.EVAPORATOR_INLET_TEMPERATURE: ["VERDAMPFEREINTRITTSTEMPERATUR", "EVAPORATOR INLET TEMPERATURE", "TEMP. ENTREE EVAPORATEUR", "TEMP. ENTRÉE ÉVAPORATEUR"],
    CanonicalKey.EVAPORATOR_OUTLET_TEMPERATURE: ["VERDAMPFERAUSTRITTSTEMPERATUR", "EVAPORATOR OUTLET TEMPERATURE", "TEMP. SORTIE EVAPORATEUR", "TEMP. SORTIE ÉVAPORATEUR"],
