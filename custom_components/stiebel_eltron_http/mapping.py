...
HEADER_ALIASES: dict[CanonicalKey, list[str]] = {
    ...
    CanonicalKey.PROCESS_DATA_SECTION: ["PROCESS DATA", "PROZESSDATEN", "PROZESS DATEN", "PROZESS-DATEN", "DONNEES DE PROCESSUS", "DONNEES PROCESS", "PROCESGEGEVENS", "DATI DI PROCESSO", "DATI PROCESSO", "PROCESSDATA"],
    ...
    CanonicalKey.AMOUNT_OF_HEAT_SECTION: ["AMOUNT OF HEAT", "MENGE DER WÄRME", "WÄRMEMENGE", "MENGE", "QUANTITE DE CHALEUR", "HOEVEELHEID WARMTE", "QUANTITA DI CALORE", "QUANTITA CALORE", "QUANTITÀ CALORE", "VÄRMEMÄNGD"],
    ...
    CanonicalKey.OIL_SUMP_TEMPERATURE: ["ÖLSUMPFTEMPERATUR", "OELSUMPFTEMPERATUR", "OIL SUMP TEMPERATURE", "TEMP. CARTER HUILE", "TEMPERATURE CARTER HUILE", "OLIECARTERTEMPERATUUR", "TEMPERATURA COPPA OLIO", "TEMP COPPA OLIO", "OLJESUMPTEMPERATUR"],
    CanonicalKey.LOW_PRESSURE: ["DRUCK NIEDERDRUCK", "NIEDERDRUCK", "LOW PRESSURE", "PRESSION BP", "BASSE PRESSION", "PRESSION BASSE PRESSION", "DRUK LAGEDRUK", "PRESS BASSA PRESSIONE", "BASSA PRESSIONE", "TRYCK LÅGTRYCK"],
    CanonicalKey.HIGH_PRESSURE: ["DRUCK HOCHDRUCK", "HOCHDRUCK", "HIGH PRESSURE", "PRESSION HP", "HAUTE PRESSION", "PRESSION HAUTE PRESSION", "DRUK HOGEDRUK", "PRESS ALTA PRESSIONE", "ALTA PRESSIONE", "TRYCK HÖGTRYCK"],
    CanonicalKey.WATER_FLOW: ["WP WASSERVOLUMENSTROM", "WASSERVOLUMENSTROM", "WATER FLOW", "WATER VOLUME FLOW", "DEBIT EAU PAC", "DEBIT D'EAU", "WP WATERDEBIET", "WATERDEBIET", "FLUSSO VOL ACQUA WP", "FLUSSO ACQUA", "WP VATTENVOLYMSTRÖM", "VATTENVOLYMSTRÖM"],
    CanonicalKey.INVERTER_CURRENT: ["STROM INVERTER", "INVERTER CURRENT", "COURANT ONDULEUR", "INTENSITE ONDULEUR", "INTENSITE INVERTER", "STROOM INVERTER", "CORRENTE INVERTER", "STRÖM INVERTER"],
    CanonicalKey.INVERTER_VOLTAGE: ["SPANNUNG INVERTER", "SPANNUNG", "INVERTER VOLTAGE", "VOLTAGE", "TENSION ONDULEUR", "TENSION INVERTER", "SPANNING INVERTER", "TENSIONE INVERTER", "SPÄNNING INVERTER"],
    ...
    CanonicalKey.EVAPORATOR_INLET_TEMPERATURE: ["VERDAMPFEREINTRITTSTEMPERATUR", "EVAPORATOR INLET TEMPERATURE", "TEMP. ENTREE EVAPORATEUR", "TEMP. ENTRÉE ÉVAPORATEUR", "INGANGSTEMPERATUUR VERDAMPER", "TEMPERATURA INGRESSO EVAPORATORE", "TEMP INGRESSO EVAPORATORE", "FÖRÅNGARENS INLOPPSTEMPERATUR"],
    CanonicalKey.EVAPORATOR_OUTLET_TEMPERATURE: ["VERDAMPFERAUSTRITTSTEMPERATUR", "EVAPORATOR OUTLET TEMPERATURE", "TEMP. SORTIE EVAPORATEUR", "TEMP. SORTIE ÉVAPORATEUR", "UITGANGSTEMPERATUUR VERDAMPER", "TEMPERATURA USCITA EVAPORATORE", "TEMP USCITA EVAPORATORE", "FÖRÅNGARENS UTLOPPSTEMPERATUR"],
