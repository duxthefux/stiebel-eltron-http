...
HEADER_ALIASES: dict[CanonicalKey, list[str]] = {
    ...
    CanonicalKey.ROOM_TEMPERATURE_SECTION: ["ROOM TEMPERATURE", "RAUMTEMPERATUR", "RAUM TEMPERATUR", "TEMP. AMBIANT", "TEMP. AMBIANTE", "KAMERTEMP", "KAMERTEMP."],
    CanonicalKey.HEATING_SECTION: ["HEATING", "HEIZUNG", "CHAUFFAGE", "VERWARMING"],
    CanonicalKey.PROCESS_DATA_SECTION: ["PROCESS DATA", "PROZESSDATEN", "PROZESS DATEN", "PROZESS-DATEN", "DONNEES DE PROCESSUS", "DONNEES PROCESS", "PROCESGEGEVENS"],
    CanonicalKey.DHW_SECTION: ["DHW", "Warmwasser", "WW", "TRINKWASSER", "DHW (Warmwasser)", "EAU CHAUDE SA", "EAU CHAUDE SANITAIRE", "ECS", "WARM WATER"],

    # Sections on the "Info > Heat Pump" page
    CanonicalKey.AMOUNT_OF_HEAT_SECTION: ["AMOUNT OF HEAT", "MENGE DER WÄRME", "WÄRMEMENGE", "MENGE", "QUANTITE DE CHALEUR", "HOEVEELHEID WARMTE"],
    ...
    CanonicalKey.EFFICIENCY_SECTION: ["EFFICIENCY", "EFFIZIENZ", "EFFICACITE", "EFFICACITÉ", "EFFICIENTIE"],

    # Diagnosis
    CanonicalKey.ISG_SECTION: ["ISG"],

    # Start page labels
    CanonicalKey.START_BETRIEBSART: ["BETRIEBSART", "OPERATION", "OPERATION MODE", "OPERATING MODE", "MODE", "MODE DE FONCTIONNEMENT", "BEDRIJFSMODUS"],
    ...
    CanonicalKey.ACTUAL_TEMPERATURE_1: ["ACTUAL TEMPERATURE 1", "ISTTEMPERATUR HK 1", "ISTTEMPERATUR 1", "ISTTEMPERATUR", "CONSIGNE TEMP. CC1", "ACTUELE TEMPERATUUR HK 1"],
    CanonicalKey.RELATIVE_HUMIDITY_1: ["RELATIVE HUMIDITY 1", "RAUMFEUCHTE 1", "RAUMFEUCHTE", "RELATIVE HUMIDITY", "HUMIDITE RELATIVE 1", "RELATIEVE VOCHTIGHEID 1"],
    ...
    CanonicalKey.ACTUAL_TEMPERATURE: ["ACTUAL TEMPERATURE", "ISTTEMPERATUR", "TEMP. REELLE", "TEMPERATURE REELLE", "ACTUELE TEMPERATUUR"],
    ...
    CanonicalKey.HOT_GAS_TEMPERATURE: ["HEISSGASTEMPERATUR", "HOT GAS TEMPERATURE", "TEMP. GAZ CHAUDS", "TEMPERATURE GAZ CHAUDS", "PERSGASTEMPERATUUR"],
    ...
    CanonicalKey.OIL_SUMP_TEMPERATURE: ["ÖLSUMPFTEMPERATUR", "OELSUMPFTEMPERATUR", "OIL SUMP TEMPERATURE", "TEMP. CARTER HUILE", "TEMPERATURE CARTER HUILE", "OLIECARTERTEMPERATUUR"],
    CanonicalKey.LOW_PRESSURE: ["DRUCK NIEDERDRUCK", "NIEDERDRUCK", "LOW PRESSURE", "PRESSION BP", "BASSE PRESSION", "PRESSION BASSE PRESSION", "DRUK LAGEDRUK"],
    CanonicalKey.HIGH_PRESSURE: ["DRUCK HOCHDRUCK", "HOCHDRUCK", "HIGH PRESSURE", "PRESSION HP", "HAUTE PRESSION", "PRESSION HAUTE PRESSION", "DRUK HOGEDRUK"],
    CanonicalKey.WATER_FLOW: ["WP WASSERVOLUMENSTROM", "WASSERVOLUMENSTROM", "WATER FLOW", "WATER VOLUME FLOW", "DEBIT EAU PAC", "DEBIT D'EAU", "WP WATERDEBIET", "WATERDEBIET"],
    CanonicalKey.INVERTER_CURRENT: ["STROM INVERTER", "INVERTER CURRENT", "COURANT ONDULEUR", "INTENSITE ONDULEUR", "INTENSITE INVERTER", "STROOM INVERTER"],
    CanonicalKey.INVERTER_VOLTAGE: ["SPANNUNG INVERTER", "SPANNUNG", "INVERTER VOLTAGE", "VOLTAGE", "TENSION ONDULEUR", "TENSION INVERTER", "SPANNING INVERTER"],
    ...
    CanonicalKey.EVAPORATOR_INLET_TEMPERATURE: ["VERDAMPFEREINTRITTSTEMPERATUR", "EVAPORATOR INLET TEMPERATURE", "TEMP. ENTREE EVAPORATEUR", "TEMP. ENTRÉE ÉVAPORATEUR", "INGANGSTEMPERATUUR VERDAMPER"],
    CanonicalKey.EVAPORATOR_OUTLET_TEMPERATURE: ["VERDAMPFERAUSTRITTSTEMPERATUR", "EVAPORATOR OUTLET TEMPERATURE", "TEMP. SORTIE EVAPORATEUR", "TEMP. SORTIE ÉVAPORATEUR", "UITGANGSTEMPERATUUR VERDAMPER"],
