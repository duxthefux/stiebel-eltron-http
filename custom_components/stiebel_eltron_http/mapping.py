...
HEADER_ALIASES: dict[CanonicalKey, list[str]] = {
    ...
    CanonicalKey.PROCESS_DATA_SECTION: ["PROCESS DATA", "PROZESSDATEN", "PROZESS DATEN", "PROZESS-DATEN", "DONNEES DE PROCESSUS", "DONNEES PROCESS", "PROCESGEGEVENS", "DATI DI PROCESSO", "DATI PROCESSO", "PROCESSDATA", "DATOS DE PROCESO", "DANE PROCESU", "PROCESNI DATA", "FOLYAMATADATOK", "PROSESSITIEDOT", "PROCESDATA"],
    ...
    CanonicalKey.AMOUNT_OF_HEAT_SECTION: ["AMOUNT OF HEAT", "MENGE DER WÄRME", "WÄRMEMENGE", "MENGE", "QUANTITE DE CHALEUR", "HOEVEELHEID WARMTE", "QUANTITA DI CALORE", "QUANTITA CALORE", "QUANTITÀ CALORE", "VÄRMEMÄNGD", "CAUDAL CALORÍFICO", "CAUDAL CALORIFICO", "ILOSC CIEPLA", "MNOZSTVI TEPLA", "HÕMENNYISÉG", "HOMENNYISEG", "LÄMPÖMÄÄRÄ", "LAMPOMAARA", "VARMEMÆNGDE", "VARMEMAENGDE"],
    ...
    CanonicalKey.HOT_GAS_TEMPERATURE: ["HEISSGASTEMPERATUR", "HOT GAS TEMPERATURE", "TEMP. GAZ CHAUDS", "TEMPERATURE GAZ CHAUDS", "PERSGASTEMPERATUUR", "TEMP GAS CALDO", "TEMPERATURA GAS CALDO", "HETGASTEMPERATUR", "TEMP. DEL GAS CALIENTE", "TEMP. GAZU GORACEGO", "TEPLOTA HORKEHO PLYNU", "FORRÓGÁZ-HÕMÉRSÉKLET", "FORROGAZ-HOMERSEKLET", "KUUMAKAASULÄMPÖT", "KUUMAKAASULÄMPOT", "KUUMAKAASULÄMPOT", "VARMEGASTEMPERATUR"],
    ...
    CanonicalKey.LOW_PRESSURE: ["DRUCK NIEDERDRUCK", "NIEDERDRUCK", "LOW PRESSURE", "PRESSION BP", "BASSE PRESSION", "PRESSION BASSE PRESSION", "DRUK LAGEDRUK", "PRESS BASSA PRESSIONE", "BASSA PRESSIONE", "TRYCK LÅGTRYCK", "PRESIÓN BAJA PRESIÓN", "PRESION BAJA PRESION", "WART NISKIEGO CISNIENIA", "TLAK NIZKY TLAK", "NYOMÁS ALACSONY NYOMÁS", "NYOMAS ALACSONY NYOMAS", "PAINE ALAPAINE", "TRYK LAVTRYK"],
    CanonicalKey.HIGH_PRESSURE: ["DRUCK HOCHDRUCK", "HOCHDRUCK", "HIGH PRESSURE", "PRESSION HP", "HAUTE PRESSION", "PRESSION HAUTE PRESSION", "DRUK HOGEDRUK", "PRESS ALTA PRESSIONE", "ALTA PRESSIONE", "TRYCK HÖGTRYCK", "PRESIÓN ALTA PRESIÓN", "PRESION ALTA PRESION", "WART WYSOKIEGO CISNIENIA", "TLAK VYSOKY TLAK", "NYOMÁS NAGYNYOMÁS", "NYOMAS NAGYNYOMAS", "PAINE KORKEAP", "TRYK HØJTRYK", "TRYK HOJTRYK"],
    CanonicalKey.WATER_FLOW: ["WP WASSERVOLUMENSTROM", "WASSERVOLUMENSTROM", "WATER FLOW", "WATER VOLUME FLOW", "DEBIT EAU PAC", "DEBIT D'EAU", "WP WATERDEBIET", "WATERDEBIET", "FLUSSO VOL ACQUA WP", "FLUSSO ACQUA", "WP VATTENVOLYMSTRÖM", "VATTENVOLYMSTRÖM", "CAUDAL AGUA WP", "WP PRZEPLYW WODY", "TC PRUTOK VODY", "WP TÉRFOGATÁRAM", "WP TERFOGATARAM", "WP VEDEN TILAVUUSVIRTA", "WP VANDVOLUMENSTRØM", "WP VANDVOLUMENSTROM"],
        CanonicalKey.INVERTER_CURRENT: ["STROM INVERTER", "INVERTER CURRENT", "COURANT INVERTER", "STROOM INVERTER", "CORRENTE INVERTER", "STRÖM INVERTER", "STROM INVERTER", "CORRIENTE INVERTER", "PRAD INWERTERA", "PROUD MERNICE", "ÁRAM INVERTER", "ARAM INVERTER", "VIRTA INVERTTERI", "STRØM INVERTER", "STRØMINVERTER", "STROMINVERTER"],
    CanonicalKey.INVERTER_VOLTAGE: ["SPANNUNG INVERTER", "SPANNUNG", "INVERTER VOLTAGE", "VOLTAGE", "TENSION ONDULEUR", "TENSION INVERTER", "SPANNING INVERTER", "TENSIONE INVERTER", "SPÄNNING INVERTER", "TENSIÓN INVERSOR", "NAPIECIE INWERTERA", "NAPETI INVERTORU", "INVERTER FESZÜLTSÉG", "INVERTER FESZULTSEG", "JÄNNITE INVERTTERI", "JANNITE INVERTTERI", "SPÆNDING INVERTER", "SPAENDING INVERTER", "SPÆNDINGSINVERTER", "SPAENDINGSINVERTER"],
    ...
    CanonicalKey.EVAPORATOR_INLET_TEMPERATURE: ["VERDAMPFEREINTRITTSTEMPERATUR", "EVAPORATOR INLET TEMPERATURE", "TEMP. ENTREE EVAPORATEUR", "TEMP. ENTRÉE ÉVAPORATEUR", "INGANGSTEMPERATUUR VERDAMPER", "TEMPERATURA INGRESSO EVAPORATORE", "TEMP INGRESSO EVAPORATORE", "FÖRÅNGARENS INLOPPSTEMPERATUR", "TEMPERATURA DE ENTRADA DEL EVAPORADOR", "TEMPERATURA WLOTU PAROWNIKA", "VÝPARNÍK, VSTUPNÍ TEPLOTA", "VÝPARNÍK, VSTUPNI TEPLOTA", "ELPÁROLOGTATÓ BEMENŐ HŐMÉRSÉKLETE", "ELPAROLOGTATO BEMENO HOMERSEKLETE", "HÖYRYSTIMEN TULOLÄMPÖTILA", "HÖYRYSTIMEN TULOLAMPOTILA", "HOYRYSTIMEN TULOLÄMPÖTILA", "HOYRYSTIMEN TULOLAMPOTILA", "FORDAMPER-INDGANGSTEMPERATUR", "FORDAMPER INDGANGSTEMPERATUR"],
    CanonicalKey.EVAPORATOR_OUTLET_TEMPERATURE: ["VERDAMPFERAUSTRITTSTEMPERATUR", "EVAPORATOR OUTLET TEMPERATURE", "TEMP. SORTIE EVAPORATEUR", "TEMP. SORTIE ÉVAPORATEUR", "UITGANGSTEMPERATUUR VERDAMPER", "TEMPERATURA USCITA EVAPORATORE", "TEMP USCITA EVAPORATORE", "FÖRÅNGARENS UTLOPPSTEMPERATUR", "TEMPERATURA DE SALIDA DEL EVAPORADOR", "TEMPERATURA WYLOTU PAROWNIKA", "VÝPARNÍK, VÝSTUPNÍ TEPLOTA", "VÝPARNÍK, VYSTUPNI TEPLOTA", "ELPÁROLOGTATÓ KIMENŐ HŐMÉRSÉKLETE", "ELPAROLOGTATO KIMENO HOMERSEKLETE", "HÖYRYSTIMEN LÄHTÖLÄMPÖTILA", "HÖYRYSTIMEN LAHTOLAMPOTILA", "HOYRYSTIMEN LÄHTÖLÄMPÖTILA", "HOYRYSTIMEN LAHTOLAMPOTILA", "FORDAMPER-UDGANGSTEMPERATUR", "FORDAMPER UDGANGSTEMPERATUR"],
