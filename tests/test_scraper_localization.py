...
def _all_localized_files():
    # find files like s_1_1_de.html, s_1_1_en.html, s_1_1_fr.html, s_1_1_nl.html, s_1_1_it.html, s_1_1_sv.html, s_1_1_es.html, s_1_1_pl.html, s_1_1_cs.html, s_1_1_hu.html, s_1_1_fi.html, s_1_1_da.html
    files = (
        ...
        + list(TESTDATA_DIR.glob("*_fi.html"))
        + list(TESTDATA_DIR.glob("*_da.html"))
    )
    return sorted(files)
...
def test_auto_detect_language(scraper_client, file_path: Path):
    ...
    if lang_elem and lang_elem.string:
        ...
        if "english" in link_text:
            ...
            expected = "hu"
        elif "suomi" in link_text or "finnish" in link_text:
            expected = "fi"
        elif "dansk" in link_text or "danish" in link_text:
            expected = "da"
    ...
    if expected is None:
        ...
        if file_path.name.endswith("_de.html"):
            ...
            expected = "hu"
        elif file_path.name.endswith("_fi.html"):
            expected = "fi"
        elif file_path.name.endswith("_da.html"):
            expected = "da"
...
@pytest.mark.parametrize("file_path", [
    ...
    TESTDATA_DIR / "s_1_1_fi.html",
    TESTDATA_DIR / "s_1_1_da.html",
])
def test_all_process_values_parsing(scraper_client, file_path: Path):
    ...
    The test runs against German, English, French, Dutch, Italian, Swedish, Spanish, Polish, Czech, Hungarian, Finnish, and Danish snapshots and asserts that for a
